...
**TrackJudge сначала загружает до пяти публикаций одного трека через `yt-dlp`, затем локально сравнивает их спектр и сохраняет самый качественный источник без повторного кодирования, когда это возможно.**
